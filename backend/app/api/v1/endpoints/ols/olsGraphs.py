...
async def graph(uuid: str):
    ...
    metric_names = [
        ...
        "post_feedback",
        "post_query",
        "post_streaming_query",
        "post_query_with_cache",
    ...
    for (plKey, plValue), (clKey, clValue), (paKey, paValue), (caKey, caValue) in zip(
        previousLatencies.items(),
    ...
    return {"latencyResults": latencyResults, "apiResults": apiResults}
        ...
        "query": {
            "bool": {
                "filter": [
                    ...
                    {"terms": {"metricName.keyword": metric_names}},
                ]
            }
        },
        "aggs": {
            "group_by_metric": {
                "terms": {"field": "metricName.keyword", "size": 10000},
                "aggs": {
                    "avg_p99Latency": {"avg": {"field": "p99Latency", "missing": 0}},
                    "avg_statuscode_200": {
                        "avg": {"field": "statusCodes.200", "missing": 0}
                    },
                },
            }
        },
