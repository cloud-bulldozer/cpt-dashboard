...
const SummaryDateFilter = ({ startDate, endDate, onDateChange, onApply }) => {
  ...
  return (
    <Toolbar id="summary-date-filter-toolbar" ouiaId="summary_date_filter">
...
export default SummaryDateFilter;
